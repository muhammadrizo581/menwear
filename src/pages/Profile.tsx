      ...
      <div className="min-h-screen bg-[#0c0c0c] text-white">
        <div className="container py-12">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <p className="text-gray-400 mt-2">Шахсий маълумотларингиз</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-8">
              <Button
                ...
                className="w-full bg-[#d4af37] text-black font-semibold hover:bg-[#b8952e] transition-all duration-300"
              >
                Менинг буюртмаларим
              </Button>
            </div>
